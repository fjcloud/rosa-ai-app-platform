...
# recycle Kuadrant after Gateway API CRDs exist, then dashboard GPU taints
# + MaaS UI flags.
set -euo pipefail
...
echo "Platform instances configured (Authorino TLS + MaaS Gateway + Kuadrant + dashboard)."
