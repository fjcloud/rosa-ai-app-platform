...
* *OpenShift AI* with Models-as-a-Service serving *Qwen3.8-27B* (Red Hat AI INT4) behind a governed OpenAI-compatible HTTPS API, plus the OpenShift AI dashboard for catalog and keys
...
* A complete *Fortune Cookie application* generated live by OpenCode + Qwen3.8: Go binary, web UI, Kustomize manifests
...
* How OpenShift AI (dashboard + `LLMInferenceService` + Models-as-a-Service) provides a governed, OpenAI-compatible LLM API on your own cluster
...
| 1.4
| Deploy Qwen3.8 as Models-as-a-Service
