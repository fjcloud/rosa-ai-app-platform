...
Log into your pre-provisioned ROSA cluster, verify `oc` and `rosa`, and confirm you are ready for the Monday story: an *in-cluster* coding agent. Source code stays on this cluster — no public LLM.

Your cluster was provisioned before the workshop began. You do not create it.
...
----
+
You should see two or three worker nodes. *No GPU node yet* — you will create it in Lab 1.1.
